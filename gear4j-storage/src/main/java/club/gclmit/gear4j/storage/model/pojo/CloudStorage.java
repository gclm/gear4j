...
package club.gclmit.gear4j.storage.model.pojo;
...
public class CloudStorage implements Serializable {
	...
	public String toString() {
        return "CloudStorage{" + "accessKeyId='" + accessKeyId + '\'' + ", accessKeySecret='" + accessKeySecret + '\''
            + ", bucket='" + bucket + '\'' + ", endpoint='" + endpoint + '\'' + ", region='" + region + '\''
            + ", prefix='" + prefix + '\'' + ", styleName='" + styleName + '\'' + ", protocol='" + protocol + '\''
            +
			'}';
	}
}
