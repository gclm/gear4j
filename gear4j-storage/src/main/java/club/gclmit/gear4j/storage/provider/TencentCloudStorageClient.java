...
public class TencentCloudStorageClient extends AbstractStorageClient {
	...
	public TencentCloudStorageClient(CloudStorage cloudStorage) {
		super(cloudStorage);
		if (cloudStorage.getType() == StorageServer.TENCENT) {
			cloudStorageConfig = cloudStorage.getConfig();
			log.info("腾讯云配置参数:[{}]", cloudStorage);
			cosClient = build(cloudStorageConfig.getAccessKeyId(), cloudStorageConfig.getAccessKeySecret(), cloudStorageConfig.getRegion());
		} else {
	...
	public void batchDelete(List<String> keys) {
		...
		DeleteObjectsRequest deleteObjectsRequest = new DeleteObjectsRequest(cloudStorageConfig.getBucket());
	...
	public void delete(String key) {
		...
		cosClient.deleteObject(cloudStorageConfig.getBucket(), key);
	}
	...
	public FileInfo upload(InputStream inputStream, FileInfo fileInfo) {
		...
		try {
			...
			PutObjectRequest putObjectRequest = new PutObjectRequest(cloudStorageConfig.getBucket(), key, inputStream, objectMetadata);
		...
		if (key != null) {
			...
			path.append(cloudStorageConfig.getProtocol()).append("://").append(cloudStorageConfig.getBucket()).append(".cos.").append(cloudStorageConfig.getRegion()).append(".myqcloud.com").append("/").append(key);
