...
package club.gclmit.gear4j.cos;
...
public class StorageClientTest {
    ...
    public static final String FILE_PATH = "/Users/gclm/Pictures/项目/微信公众号/images-5.jpg";
    ...
    static class TestConfig {
        ...
        public CosProvider cosProvider() {
            return CosProvider.builder().provider(CosProviderType.ALIYUN.getCode()).accessKeyId("accessKeyId")
                .accessKeySecret("accessKeySecret").bucket("bucket").region("region").prefix("prefix").build();
        }
    ...
    public void uploadFile() {
        ...
        System.out.println(cosClient.upload(new File(FILE_PATH)));
        System.out.println("=================================");
    }
    ...
    public void uploadByte() {
        ...
        System.out.println(cosClient.upload("hi,gclm"));
        System.out.println("=================================");
    }
    ...
    public void delete() {
        ...
        cosClient.delete("images/20220628/7LFPFRX2TBV7KCP.jpg");
        System.out.println("=================================");
    }
    ...
    public void batchDelete() {
        ...
        cosClient.batchDelete(List.of(""));
        System.out.println("=================================");
    }

    // ================== 单独使用
    private static void uploadFile2(CosClient client, File file) {
        System.out.println("===============文件上传===============");
        System.out.println(client.upload(file));
        System.out.println("=================================");
    }

    private static void uploadByte2(CosClient client, String content) {
        System.out.println("===============字节上传===============");
        String fileName = IdUtil.fastSimpleUUID() + ".txt";
        String key = IdUtil.fastSimpleUUID();
        System.out.println(client.upload(content));
        System.out.println("=================================");
    }
    ...
    private static void batchDelete2(CosClient client, List<String> keys) {
        System.out.println("===============文件批量删除===============");
    ...
    public void aliyun() {
        ...
        CosClient client = CosClientBuilder.getClient(cosProvider);
        uploadByte2(client, "hi,gclm");
        uploadFile2(client, new File(FILE_PATH));
    }
