 ...
 * @since jdk11
 */
public class GoFastdfsCosClient extends AbstractCosClient implements CosClient {
    ...
    public void delete(String key) {
        ...
        String result = OkHttps.async(url).addHeader(HttpClient.header()).get().getResult().getBody().toString();
