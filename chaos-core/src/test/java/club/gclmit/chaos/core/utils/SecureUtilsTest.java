...
public class SecureUtilsTest {
	...
	@BeforeEach
	public void init() {
		KeyPair keyPair = SecureUtils.generateKeyPair("rsa");
	 ...
	 */
	@Test
	@DisplayName("rsa-公钥加密私钥解密")
	public void test1() throws Exception {
		System.out.println("***************** 公钥加密私钥解密开始 *****************");
		String text1 = rsa.encryptHex(SRC, KeyType.PublicKey);
	 ...
	 */
	@Test
	@DisplayName("rsa-私钥加密公钥解密")
	public void test2() throws Exception {
		System.out.println("***************** 私钥加密公钥解密开始 *****************");
		String text1 = rsa.encryptHex(SRC, KeyType.PrivateKey);
