...
import club.gclmit.chaos.core.util.CharUtil;
import club.gclmit.chaos.core.util.ObjectUtil;
...
public class VersionComparator implements Comparator<String>, Serializable {
	...
	public int compare(String version1, String version2) {
		...
		final List<String> v1s = StringUtils.split(version1, CharUtil.DOT);
		final List<String> v2s = StringUtils.split(version2, CharUtil.DOT);
