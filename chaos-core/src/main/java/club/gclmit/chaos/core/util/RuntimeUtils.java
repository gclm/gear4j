...
public class RuntimeUtils {
     ...
     * @since 3.1.2
     */
    public static String execForStr(Charset charset, String... cmds) throws ChaosCoreException {
     ...
     * @since 3.1.2
     */
    public static List<String> execForLines(Charset charset, String... cmds) throws ChaosCoreException {
    ...
    public static Process exec(String... cmds) {
        ...
        if (1 == cmds.length) {
            ...
            cmds = StringUtils.splitByWholeSeparator(cmd, StringUtils.SPACE);
        }
    ...
    public static String getResult(Process process, Charset charset) {
        ...
        String result = IOUtils.copy(in, charset);
        IOUtils.closeQuietly(in);
        destroy(process);
        return result;
    }
