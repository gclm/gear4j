...
public class BigDecimalUtils {
    ...
    public static class ConvertHandler {
        ...
        public static byte[] toByteArray(String data) {
            return data.getBytes(Charsets.CHARSET_UTF_8);
        }
        ...
        public static byte[] toByteArray(String data,String charset) {
            return data.getBytes(Charsets.toCharset(charset));
        }
    ...
    //	}
         ...
         */
    //	@SuppressWarnings("unchecked")
    //	public static <T> T convertByClassName(String className, Object value) throws ChaosCoreException {
    ...
    //	}
         ...
         * @since 4.0.0
         */
        public static <T> T convert(Class<T> type, Object value) throws ChaosCoreException {
         ...
         * @throws ChaosCoreException 转换器不存在
         */
        public static <T> T convert(Type type, Object value) throws ChaosCoreException {
         ...
         * @since 4.0.0
         */
        public static <T> T convert(Class<T> type, Object value, T defaultValue) throws ChaosCoreException {
         ...
         * @throws ChaosCoreException 转换器不存在
         */
        public static <T> T convert(Type type, Object value, T defaultValue) throws ChaosCoreException {
