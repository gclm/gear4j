...
public class StringHelper {
	 ...
	 * StringHelper.indexOfIgnoreCase("abc", "", 9)        = -1
	 * </pre>
	 * 
	 * @param str 字符串
	...
	public static String str(Object obj, Charset charset) {
		...
		} else if (ArrayHelper.isArray(obj)) {
			return ArrayHelper.toString(obj);
		}
	 ...
	 * 
	 * <pre>
	 * StringHelper.subSufByLength("abcde", 3)      =    "cde"
	 * StringHelper.subSufByLength("abcde", 0)      =    ""
	 * StringHelper.subSufByLength("abcde", -5)     =    ""
	 * StringHelper.subSufByLength("abcde", -1)     =    ""
	 * StringHelper.subSufByLength("abcde", 5)       =    "abcde"
	 * StringHelper.subSufByLength("abcde", 10)     =    "abcde"
	 * StringHelper.subSufByLength(null, 3)               =    null
	 * </pre>
	 * 
	 * @param string 字符串
	 * @param length 切割长度
	 ...
	 * 
	 * <pre>
	 * StringHelper.subBefore(null, *)      = null
	 * StringHelper.subBefore("", *)        = ""
	 * StringHelper.subBefore("abc", "a")   = ""
	 * StringHelper.subBefore("abcba", "b") = "a"
	 * StringHelper.subBefore("abc", "c")   = "ab"
	 * StringHelper.subBefore("abc", "d")   = "abc"
	 * StringHelper.subBefore("abc", "")    = ""
	 * StringHelper.subBefore("abc", null)  = "abc"
	 * </pre>
	 * 
	 ...
	 * 
	 * <pre>
	 * StringHelper.subBetween("wx[b]yz", "[", "]") = "b"
	 * StringHelper.subBetween(null, *, *)          = null
	 * StringHelper.subBetween(*, null, *)          = null
	 * StringHelper.subBetween(*, *, null)          = null
	 * StringHelper.subBetween("", "", "")          = ""
	 * StringHelper.subBetween("", "", "]")         = null
	 * StringHelper.subBetween("", "[", "]")        = null
	 * StringHelper.subBetween("yabcz", "", "")     = ""
	 * StringHelper.subBetween("yabcz", "y", "z")   = "abc"
	 * StringHelper.subBetween("yabczyabcz", "y", "z")   = "abc"
	 * </pre>
	 * 
	 * @param str 被切割的字符串
	 ...
	 * StringHelper.subBetween(null, *)            = null
	 * StringHelper.subBetween("", "")             = ""
	 * StringHelper.subBetween("", "tag")          = null
	 * StringHelper.subBetween("tagabctag", null)  = null
	 * StringHelper.subBetween("tagabctag", "")    = ""
	 * StringHelper.subBetween("tagabctag", "tag") = "abc"
	 * </pre>
	 * 
	 * @param str 被切割的字符串
	...
	public static Object convert(Class<?> type, String[] values) throws Exception {
		...
		if (componentType.isPrimitive()) {
			...
			Object[] ret = ArrayHelper.newArray(componentType, values.length);
			for (int i = 0; i < ret.length; i++) {
