...
/**
 * this class copied from org.apache.commons.io.IOHelper
 */
public class IOHelper {
	 ...
	 * before using {@link IOHelper#toByteArray(java.io.InputStream, int)} to read into the byte array.
	 ...
	 * @see IOHelper#toByteArray(java.io.InputStream, int)
	 * @since 2.1
	 */
	...
	public static URL resourceToURL(final String name, final ClassLoader classLoader) throws IOException {
		...
		final URL resource = classLoader == null ? IOHelper.class.getResource(name) : classLoader.getResource(name);
