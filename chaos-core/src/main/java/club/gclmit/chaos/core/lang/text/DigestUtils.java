...
public class DigestUtils {
    ...
    public static String to62Str(long i) {
        ...
        return new String(buf, charPos, (65 - charPos), Charsets.CHARSET_UTF_8);
    }
    ...
    public static byte[] md5(String data) {
        return md5(BigDecimalUtils.ConvertHandler.toByteArray(data));
    }
    ...
    public static byte[] sha1(String data) {
        return sha1(BigDecimalUtils.ConvertHandler.toByteArray(data));
    }
    ...
    public static byte[] sha224(String data) {
        return sha224(BigDecimalUtils.ConvertHandler.toByteArray(data));
    }
    ...
    public static byte[] sha256(String data) {
        return sha256(BigDecimalUtils.ConvertHandler.toByteArray(data));
    }
    ...
    public static String sha256Hex(String data) {
        return encodeHex(sha256(BigDecimalUtils.ConvertHandler.toByteArray(data)));
    }
    ...
    public static byte[] sha384(String data) {
        return sha384(BigDecimalUtils.ConvertHandler.toByteArray(data));
    }
    ...
    public static String sha384Hex(String data) {
        return encodeHex(sha384(BigDecimalUtils.ConvertHandler.toByteArray(data)));
    }
    ...
    public static byte[] sha512(String data) {
        return sha512(BigDecimalUtils.ConvertHandler.toByteArray(data));
    }
    ...
    public static String sha512Hex(String data) {
        return encodeHex(sha512(BigDecimalUtils.ConvertHandler.toByteArray(data)));
    }
    ...
    public static byte[] hmacMd5(String data, String key) {
        return hmacMd5(BigDecimalUtils.ConvertHandler.toByteArray(data), key);
    }
    ...
    public static String hmacMd5Hex(String data, String key) {
        return encodeHex(hmacMd5(BigDecimalUtils.ConvertHandler.toByteArray(data), key));
    }
    ...
    public static byte[] hmacSha1(String data, String key) {
        return hmacSha1(BigDecimalUtils.ConvertHandler.toByteArray(data), key);
    }
    ...
    public static String hmacSha1Hex(String data, String key) {
        return encodeHex(hmacSha1(BigDecimalUtils.ConvertHandler.toByteArray(data), key));
    }
    ...
    public static byte[] hmacSha224(String data, String key) {
        return hmacSha224(BigDecimalUtils.ConvertHandler.toByteArray(data), key);
    }
    ...
    public static String hmacSha224Hex(String data, String key) {
        return encodeHex(hmacSha224(BigDecimalUtils.ConvertHandler.toByteArray(data), key));
    }
    ...
    public static byte[] hmacSha256(String data, String key) {
        return hmacSha256(BigDecimalUtils.ConvertHandler.toByteArray(data), key);
    }
    ...
    public static String hmacSha256Hex(String data, String key) {
        return encodeHex(hmacSha256(BigDecimalUtils.ConvertHandler.toByteArray(data), key));
    }
    ...
    public static byte[] hmacSha384(String data, String key) {
        return hmacSha384(BigDecimalUtils.ConvertHandler.toByteArray(data), key);
    }
    ...
    public static String hmacSha384Hex(String data, String key) {
        return encodeHex(hmacSha384(BigDecimalUtils.ConvertHandler.toByteArray(data), key));
    }
    ...
    public static byte[] hmacSha512(String data, String key) {
        return hmacSha512(BigDecimalUtils.ConvertHandler.toByteArray(data), key);
    }
    ...
    public static String hmacSha512Hex(String data, String key) {
        return encodeHex(hmacSha512(BigDecimalUtils.ConvertHandler.toByteArray(data), key));
    }
    ...
    public static byte[] digestHmac(String algorithm, final byte[] bytes, String key) {
        SecretKey secretKey = new SecretKeySpec(key.getBytes(Charsets.CHARSET_UTF_8), algorithm);
        try {
    ...
    public static boolean slowEquals(@Nullable String a, @Nullable String b) {
        ...
        return slowEquals(a.getBytes(Charsets.CHARSET_UTF_8), b.getBytes(Charsets.CHARSET_UTF_8));
    }
