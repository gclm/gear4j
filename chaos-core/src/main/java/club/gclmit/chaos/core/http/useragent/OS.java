...
public class OS extends UserAgentInfo {
	 ...
	 * 未知
	 */
	public static final OS OS_UNKNOWN = new OS(NAME_UNKNOWN, null);

	/**
	 * 支持的引擎类型
	 */
	public static final List<OS> OS_LIST = CollUtil.newArrayList(
	...
	synchronized public static void addCustomOs(String name, String regex, String versionRegex) {
		OS_LIST.add(new OS(name, regex, versionRegex));
	}
