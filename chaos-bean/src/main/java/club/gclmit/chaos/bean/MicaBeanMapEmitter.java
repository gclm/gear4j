...
import club.gclmit.chaos.bean.util.ReflectionUtils;
...
class MicaBeanMapEmitter extends ClassEmitter {
    ...
    public MicaBeanMapEmitter(ClassVisitor v, String className, Class type, int require) {
        ...
        Map<String, PropertyDescriptor> getters = makePropertyMap(ReflectionUtils.getBeanGetters(type));
        Map<String, PropertyDescriptor> setters = makePropertyMap(ReflectionUtils.getBeanSetters(type));
