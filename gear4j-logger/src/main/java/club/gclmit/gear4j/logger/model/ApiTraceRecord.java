...
package club.gclmit.gear4j.logger.model;
...
public class ApiTraceRecord implements Serializable {
	...
	public ApiTraceRecord(Long id, String clientIp, String uri, String contentType, String method, String sessionId, Long requestTime, int httpCode, Long consumingTime, Long responseTime, String requestBody, String responseBody, String requestHeader, String responseHeader, String userAgent) {
		this.id = id;
