...
public class HttpTrace implements Serializable {
    ...
    public HttpTrace(Long id, String clientIp, String uri, String contentType, String method, String sessionId, Long requestTime, int httpCode, Long consumingTime, Long responseTime, String requestBody, String responseBody, String requestHeader, String responseHeader, String userAgent) {
        this.id = id;
